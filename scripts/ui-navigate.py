...
def main():
    ...
    with open(os.path.join(ART, "LOG-SOURCES.txt"), "w") as f:
        f.write(
            ...
            "# HOST   host-restart-forensics.txt watchdog/runtime-restart markers + CPU-\n"
            ...
            "# GUEST  property-values.txt        strings-probe of the guest property\n"
            "#                                   area CONTEXT FILES (which ro./sys./\n"
            "#                                   init.svc.* values actually LANDED in\n"
            "#                                   the guest area — the decisive artifact\n"
            "#                                   for landed-vs-denied property sets;\n"
            "#                                   6-Z305p lesson: the area LISTING alone\n"
