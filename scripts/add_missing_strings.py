...
MISSING_STRINGS = [
    ...
    ("profile_create_failed",
     ...
     "建立設定檔失敗",
     "プロファイルの作成に失敗しました"),
    # ---- pre-existing strings that were never translated
    #      (caught by lint once the build got past Java compile) ----
    ("profile_copy_hint",
     "New profile name",
     "新配置文件名",
     "新設定檔名稱",
    ...
    ("profile_export_failed",
     "Failed to export profile: %1$s",
     "导出配置文件失败：%1$s",
     "匯出設定檔失敗：%1$s",
     "プロファイルのエクスポートに失敗しました: %1$s"),
    ...
    ("profile_import_failed",
     "Failed to import profile: %1$s",
     "导入配置文件失败：%1$s",
     "匯入設定檔失敗：%1$s",
     "プロファイルのインポートに失敗しました: %1$s"),
