...
size_t renderControl_decoder_context_t::decode(void *buf, size_t len, IOStream *stream)
{
	...
	while ((len - pos >= 8) && !unknownOpcode) {   
		...
		switch(opcode) {
			...
			fprintf(stderr,"renderControl: rcGetRendererVersion()\n");
#endif
...
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcGetEGLVersion(%p(%u) %p(%u) )\n",(EGLint*)(tmpPtr0), *(unsigned int *)(ptr + 8), (EGLint*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4));
#endif
...
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcQueryEGLString(0x%08x %p(%u) 0x%08x )\n",*(EGLenum *)(ptr + 8), (void*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4), *(EGLint *)(ptr + 8 + 4 + 4));
#endif
			*(EGLint *)(&tmpBuf[0 + tmpPtr1Size]) = 			this->rcQueryEGLString(*(EGLenum *)(ptr + 8), (void*)(tmpPtr1), *(EGLint *)(ptr + 8 + 4 + 4));
			...
			unsigned char *tmpPtr1 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcGetGLString(0x%08x %p(%u) 0x%08x )\n",*(EGLenum *)(ptr + 8), (void*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4), *(EGLint *)(ptr + 8 + 4 + 4));
#endif
			*(EGLint *)(&tmpBuf[0 + tmpPtr1Size]) = 			this->rcGetGLString(*(EGLenum *)(ptr + 8), (void*)(tmpPtr1), *(EGLint *)(ptr + 8 + 4 + 4));
			...
			unsigned char *tmpPtr0 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcGetNumConfigs(%p(%u) )\n",(uint32_t*)(tmpPtr0), *(unsigned int *)(ptr + 8));
#endif
			*(EGLint *)(&tmpBuf[0 + tmpPtr0Size]) = 			this->rcGetNumConfigs((uint32_t*)(tmpPtr0));
			...
			unsigned char *tmpPtr1 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcGetConfigs(0x%08x %p(%u) )\n",*(uint32_t *)(ptr + 8), (GLuint*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4));
#endif
...
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcChooseConfig(%p(%u) 0x%08x %p(%u) 0x%08x )\n",(EGLint*)(ptr + 8 + 4), *(unsigned int *)(ptr + 8), *(uint32_t *)(ptr + 8 + 4 + *(tsize_t *)(ptr +8)), (uint32_t*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + *(tsize_t *)(ptr +8) + 4), *(uint32_t *)(ptr + 8 + 4 + *(tsize_t *)(ptr +8) + 4 + 4));
#endif
			*(EGLint *)(&tmpBuf[0 + tmpPtr2Size]) = 			this->rcChooseConfig((EGLint*)(ptr + 8 + 4), *(uint32_t *)(ptr + 8 + 4 + *(tsize_t *)(ptr +8)), tmpPtr2Size == 0 ? NULL : (uint32_t*)(tmpPtr2), *(uint32_t *)(ptr + 8 + 4 + *(tsize_t *)(ptr +8) + 4 + 4));
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcGetFBParam(0x%08x )\n",*(EGLint *)(ptr + 8));
#endif
			*(EGLint *)(&tmpBuf[0]) = 			this->rcGetFBParam(*(EGLint *)(ptr + 8));
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcCreateContext(0x%08x 0x%08x 0x%08x )\n",*(uint32_t *)(ptr + 8), *(uint32_t *)(ptr + 8 + 4), *(uint32_t *)(ptr + 8 + 4 + 4));
#endif
			*(uint32_t *)(&tmpBuf[0]) = 			this->rcCreateContext(*(uint32_t *)(ptr + 8), *(uint32_t *)(ptr + 8 + 4), *(uint32_t *)(ptr + 8 + 4 + 4));
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcDestroyContext(0x%08x )\n",*(uint32_t *)(ptr + 8));
#endif
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcCreateWindowSurface(0x%08x 0x%08x 0x%08x )\n",*(uint32_t *)(ptr + 8), *(uint32_t *)(ptr + 8 + 4), *(uint32_t *)(ptr + 8 + 4 + 4));
#endif
			*(uint32_t *)(&tmpBuf[0]) = 			this->rcCreateWindowSurface(*(uint32_t *)(ptr + 8), *(uint32_t *)(ptr + 8 + 4), *(uint32_t *)(ptr + 8 + 4 + 4));
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcDestroyWindowSurface(0x%08x )\n",*(uint32_t *)(ptr + 8));
#endif
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcCreateColorBuffer(0x%08x 0x%08x 0x%08x )\n",*(uint32_t *)(ptr + 8), *(uint32_t *)(ptr + 8 + 4), *(GLenum *)(ptr + 8 + 4 + 4));
#endif
			*(uint32_t *)(&tmpBuf[0]) = 			this->rcCreateColorBuffer(*(uint32_t *)(ptr + 8), *(uint32_t *)(ptr + 8 + 4), *(GLenum *)(ptr + 8 + 4 + 4));
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcOpenColorBuffer(0x%08x )\n",*(uint32_t *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcCloseColorBuffer(0x%08x )\n",*(uint32_t *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcSetWindowColorBuffer(0x%08x 0x%08x )\n",*(uint32_t *)(ptr + 8), *(uint32_t *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcFlushWindowColorBuffer(0x%08x )\n",*(uint32_t *)(ptr + 8));
#endif
			*(int *)(&tmpBuf[0]) = 			this->rcFlushWindowColorBuffer(*(uint32_t *)(ptr + 8));
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcMakeCurrent(0x%08x 0x%08x 0x%08x )\n",*(uint32_t *)(ptr + 8), *(uint32_t *)(ptr + 8 + 4), *(uint32_t *)(ptr + 8 + 4 + 4));
#endif
			*(EGLint *)(&tmpBuf[0]) = 			this->rcMakeCurrent(*(uint32_t *)(ptr + 8), *(uint32_t *)(ptr + 8 + 4), *(uint32_t *)(ptr + 8 + 4 + 4));
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcFBPost(0x%08x )\n",*(uint32_t *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcFBSetSwapInterval(0x%08x )\n",*(EGLint *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcBindTexture(0x%08x )\n",*(uint32_t *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcBindRenderbuffer(0x%08x )\n",*(uint32_t *)(ptr + 8));
#endif
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcColorBufferCacheFlush(0x%08x 0x%08x %d )\n",*(uint32_t *)(ptr + 8), *(EGLint *)(ptr + 8 + 4), *(int *)(ptr + 8 + 4 + 4));
#endif
			*(EGLint *)(&tmpBuf[0]) = 			this->rcColorBufferCacheFlush(*(uint32_t *)(ptr + 8), *(EGLint *)(ptr + 8 + 4), *(int *)(ptr + 8 + 4 + 4));
...
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcReadColorBuffer(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x %p(%u) )\n",*(uint32_t *)(ptr + 8), *(GLint *)(ptr + 8 + 4), *(GLint *)(ptr + 8 + 4 + 4), *(GLint *)(ptr + 8 + 4 + 4 + 4), *(GLint *)(ptr + 8 + 4 + 4 + 4 + 4), *(GLenum *)(ptr + 8 + 4 + 4 + 4 + 4 + 4), *(GLenum *)(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4), (void*)(tmpPtr7), *(unsigned int *)(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4));
#endif
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"renderControl: rcUpdateColorBuffer(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x %p(%u) )\n",*(uint32_t *)(ptr + 8), *(GLint *)(ptr + 8 + 4), *(GLint *)(ptr + 8 + 4 + 4), *(GLint *)(ptr + 8 + 4 + 4 + 4), *(GLint *)(ptr + 8 + 4 + 4 + 4 + 4), *(GLenum *)(ptr + 8 + 4 + 4 + 4 + 4 + 4), *(GLenum *)(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4), (void*)(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4));
#endif
