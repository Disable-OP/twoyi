...
size_t gl_decoder_context_t::decode(void *buf, size_t len, IOStream *stream)
{
	...
	while ((len - pos >= 8) && !unknownOpcode) {   
		...
		switch(opcode) {
			...
			fprintf(stderr,"gl: glAlphaFunc(0x%08x %f )\n",*(GLenum *)(ptr + 8), *(GLclampf *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClearDepthf(%f )\n",*(GLclampf *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClipPlanef(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfloat*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glColor4f(%f %f %f %f )\n",*(GLfloat *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDepthRangef(%f %f )\n",*(GLclampf *)(ptr + 8), *(GLclampf *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glFogf(0x%08x %f )\n",*(GLenum *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glFogfv(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfloat*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glFrustumf(%f %f %f %f %f %f )\n",*(GLfloat *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr1 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetFloatv(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (GLfloat*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetMaterialfv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLfloat*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetTexEnvfv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLfloat*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetTexParameterfv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLfloat*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLightModelf(0x%08x %f )\n",*(GLenum *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLightModelfv(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfloat*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLineWidth(%f )\n",*(GLfloat *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLoadMatrixf(%p(%u) )\n",(const GLfloat*)(ptr + 8 + 4), *(unsigned int *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMaterialf(0x%08x 0x%08x %f )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMaterialfv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLfloat*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMultMatrixf(%p(%u) )\n",(const GLfloat*)(ptr + 8 + 4), *(unsigned int *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMultiTexCoord4f(0x%08x %f %f %f %f )\n",*(GLenum *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glNormal3f(%f %f %f )\n",*(GLfloat *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glOrthof(%f %f %f %f %f %f )\n",*(GLfloat *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPointParameterf(0x%08x %f )\n",*(GLenum *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPointParameterfv(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfloat*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPointSize(%f )\n",*(GLfloat *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPolygonOffset(%f %f )\n",*(GLfloat *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glRotatef(%f %f %f %f )\n",*(GLfloat *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glScalef(%f %f %f )\n",*(GLfloat *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexEnvf(0x%08x 0x%08x %f )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexEnvfv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLfloat*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexParameterf(0x%08x 0x%08x %f )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexParameterfv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLfloat*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTranslatef(%f %f %f )\n",*(GLfloat *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glActiveTexture(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glAlphaFuncx(0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLclampx *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glBindBuffer(0x%08x %u )\n",*(GLenum *)(ptr + 8), *(GLuint *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glBindTexture(0x%08x %u )\n",*(GLenum *)(ptr + 8), *(GLuint *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glBlendFunc(0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClear(0x%08x )\n",*(GLbitfield *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClearColorx(0x%08x 0x%08x 0x%08x 0x%08x )\n",*(GLclampx *)(ptr + 8), *(GLclampx *)(ptr + 8 + 4), *(GLclampx *)(ptr + 8 + 4 + 4), *(GLclampx *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClearDepthx(0x%08x )\n",*(GLclampx *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClearStencil(%d )\n",*(GLint *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClientActiveTexture(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glColor4ub(0x%02x 0x%02x 0x%02x 0x%02x )\n",*(GLubyte *)(ptr + 8), *(GLubyte *)(ptr + 8 + 1), *(GLubyte *)(ptr + 8 + 1 + 1), *(GLubyte *)(ptr + 8 + 1 + 1 + 1));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glColor4x(0x%08x 0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glColorPointer(%d 0x%08x %d %p(%u) )\n",*(GLint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLsizei *)(ptr + 8 + 4 + 4), (const GLvoid*)(ptr + 8 + 4 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glCullFace(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDeleteTextures(%d %p(%u) )\n",*(GLsizei *)(ptr + 8), (const GLuint*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDepthFunc(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDepthMask(%d )\n",*(GLboolean *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDepthRangex(0x%08x 0x%08x )\n",*(GLclampx *)(ptr + 8), *(GLclampx *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDisable(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDisableClientState(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glEnable(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glEnableClientState(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glFogx(0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glFogxv(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfixed*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glFrontFace(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glFrustumx(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClipPlanex(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfixed*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpPtr1 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGenTextures(%d %p(%u) )\n",*(GLsizei *)(ptr + 8), (GLuint*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			*(GLenum *)(&tmpBuf[0]) = 			this->glGetError();
			...
			unsigned char *tmpPtr1 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetFixedv(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (GLfixed*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetLightxv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLfixed*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetMaterialxv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLfixed*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetPointerv(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (GLvoid**)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetString(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetTexEnviv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLint*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetTexEnvxv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLfixed*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetTexParameteriv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLint*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetTexParameterxv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLfixed*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glHint(0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glIsBuffer(%u )\n",*(GLuint *)(ptr + 8));
#endif
			*(GLboolean *)(&tmpBuf[0]) = 			this->glIsBuffer(*(GLuint *)(ptr + 8));
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glIsEnabled(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			*(GLboolean *)(&tmpBuf[0]) = 			this->glIsEnabled(*(GLenum *)(ptr + 8));
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glIsTexture(%u )\n",*(GLuint *)(ptr + 8));
#endif
			*(GLboolean *)(&tmpBuf[0]) = 			this->glIsTexture(*(GLuint *)(ptr + 8));
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLightModelx(0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLightModelxv(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfixed*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLightx(0x%08x 0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLightxv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLfixed*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLineWidthx(0x%08x )\n",*(GLfixed *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLoadIdentity()\n");
#endif
			this->glLoadIdentity();
			pos += *(int *)(ptr + 4);
			ptr += *(int *)(ptr + 4);
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLoadMatrixx(%p(%u) )\n",(const GLfixed*)(ptr + 8 + 4), *(unsigned int *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLogicOp(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMaterialx(0x%08x 0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMaterialxv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLfixed*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMatrixMode(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMultMatrixx(%p(%u) )\n",(const GLfixed*)(ptr + 8 + 4), *(unsigned int *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMultiTexCoord4x(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glNormal3x(0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glNormalPointer(0x%08x %d %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLsizei *)(ptr + 8 + 4), (const GLvoid*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glOrthox(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPixelStorei(0x%08x %d )\n",*(GLenum *)(ptr + 8), *(GLint *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPointParameterx(0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPointParameterxv(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfixed*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPointSizex(0x%08x )\n",*(GLfixed *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPolygonOffsetx(0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPushMatrix()\n");
#endif
			this->glPushMatrix();
			pos += *(int *)(ptr + 4);
			ptr += *(int *)(ptr + 4);
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glRotatex(0x%08x 0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glSampleCoverage(%f %d )\n",*(GLclampf *)(ptr + 8), *(GLboolean *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glSampleCoveragex(0x%08x %d )\n",*(GLclampx *)(ptr + 8), *(GLboolean *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glScalex(0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glShadeModel(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glStencilMask(%u )\n",*(GLuint *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glStencilOp(0x%08x 0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLenum *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexCoordPointer(%d 0x%08x %d %p(%u) )\n",*(GLint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLsizei *)(ptr + 8 + 4 + 4), (const GLvoid*)(ptr + 8 + 4 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexEnvi(0x%08x 0x%08x %d )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLint *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexEnvx(0x%08x 0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexEnvxv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLfixed*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexParameteri(0x%08x 0x%08x %d )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLint *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexParameterx(0x%08x 0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexParameteriv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLint*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexParameterxv(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLfixed*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTranslatex(0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glVertexPointer(%d 0x%08x %d %p(%u) )\n",*(GLint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLsizei *)(ptr + 8 + 4 + 4), (const GLvoid*)(ptr + 8 + 4 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPointSizePointerOES(0x%08x %d %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLsizei *)(ptr + 8 + 4), (const GLvoid*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glVertexPointerOffset(%d 0x%08x %d %u )\n",*(GLint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLsizei *)(ptr + 8 + 4 + 4), *(GLuint *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glColorPointerOffset(%d 0x%08x %d %u )\n",*(GLint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLsizei *)(ptr + 8 + 4 + 4), *(GLuint *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glNormalPointerOffset(0x%08x %d %u )\n",*(GLenum *)(ptr + 8), *(GLsizei *)(ptr + 8 + 4), *(GLuint *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPointSizePointerOffset(0x%08x %d %u )\n",*(GLenum *)(ptr + 8), *(GLsizei *)(ptr + 8 + 4), *(GLuint *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexCoordPointerOffset(%d 0x%08x %d %u )\n",*(GLint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLsizei *)(ptr + 8 + 4 + 4), *(GLuint *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glWeightPointerOffset(%d 0x%08x %d %u )\n",*(GLint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLsizei *)(ptr + 8 + 4 + 4), *(GLuint *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMatrixIndexPointerOffset(%d 0x%08x %d %u )\n",*(GLint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLsizei *)(ptr + 8 + 4 + 4), *(GLuint *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glVertexPointerData(%d 0x%08x %d %p(%u) %u )\n",*(GLint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLsizei *)(ptr + 8 + 4 + 4), (void*)(ptr + 8 + 4 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4 + 4), *(GLuint *)(ptr + 8 + 4 + 4 + 4 + 4 + *(tsize_t *)(ptr +8 + 4 + 4 + 4)));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glColorPointerData(%d 0x%08x %d %p(%u) %u )\n",*(GLint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLsizei *)(ptr + 8 + 4 + 4), (void*)(ptr + 8 + 4 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4 + 4), *(GLuint *)(ptr + 8 + 4 + 4 + 4 + 4 + *(tsize_t *)(ptr +8 + 4 + 4 + 4)));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glNormalPointerData(0x%08x %d %p(%u) %u )\n",*(GLenum *)(ptr + 8), *(GLsizei *)(ptr + 8 + 4), (void*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4), *(GLuint *)(ptr + 8 + 4 + 4 + 4 + *(tsize_t *)(ptr +8 + 4 + 4)));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexCoordPointerData(%d %d 0x%08x %d %p(%u) %u )\n",*(GLint *)(ptr + 8), *(GLint *)(ptr + 8 + 4), *(GLenum *)(ptr + 8 + 4 + 4), *(GLsizei *)(ptr + 8 + 4 + 4 + 4), (void*)(ptr + 8 + 4 + 4 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4 + 4 + 4), *(GLuint *)(ptr + 8 + 4 + 4 + 4 + 4 + 4 + *(tsize_t *)(ptr +8 + 4 + 4 + 4 + 4)));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPointSizePointerData(0x%08x %d %p(%u) %u )\n",*(GLenum *)(ptr + 8), *(GLsizei *)(ptr + 8 + 4), (void*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4), *(GLuint *)(ptr + 8 + 4 + 4 + 4 + *(tsize_t *)(ptr +8 + 4 + 4)));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glWeightPointerData(%d 0x%08x %d %p(%u) %u )\n",*(GLint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLsizei *)(ptr + 8 + 4 + 4), (void*)(ptr + 8 + 4 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4 + 4), *(GLuint *)(ptr + 8 + 4 + 4 + 4 + 4 + *(tsize_t *)(ptr +8 + 4 + 4 + 4)));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMatrixIndexPointerData(%d 0x%08x %d %p(%u) %u )\n",*(GLint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLsizei *)(ptr + 8 + 4 + 4), (void*)(ptr + 8 + 4 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4 + 4), *(GLuint *)(ptr + 8 + 4 + 4 + 4 + 4 + *(tsize_t *)(ptr +8 + 4 + 4 + 4)));
#endif
			...
			unsigned char *tmpPtr1 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetCompressedTextureFormats(%d %p(%u) )\n",*(int *)(ptr + 8), (GLint*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glFinishRoundTrip()\n");
#endif
			*(int *)(&tmpBuf[0]) = 			this->glFinishRoundTrip(this);
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glBlendEquationSeparateOES(0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glBlendFuncSeparateOES(0x%08x 0x%08x 0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLenum *)(ptr + 8 + 4 + 4), *(GLenum *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glBlendEquationOES(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDrawTexsOES(%d %d %d %d %d )\n",*(GLshort *)(ptr + 8), *(GLshort *)(ptr + 8 + 2), *(GLshort *)(ptr + 8 + 2 + 2), *(GLshort *)(ptr + 8 + 2 + 2 + 2), *(GLshort *)(ptr + 8 + 2 + 2 + 2 + 2));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDrawTexxOES(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDrawTexsvOES(%p(%u) )\n",(const GLshort*)(ptr + 8 + 4), *(unsigned int *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDrawTexivOES(%p(%u) )\n",(const GLint*)(ptr + 8 + 4), *(unsigned int *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDrawTexxvOES(%p(%u) )\n",(const GLfixed*)(ptr + 8 + 4), *(unsigned int *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDrawTexfOES(%f %f %f %f %f )\n",*(GLfloat *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDrawTexfvOES(%p(%u) )\n",(const GLfloat*)(ptr + 8 + 4), *(unsigned int *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glEGLImageTargetTexture2DOES(0x%08x %p )\n",*(GLenum *)(ptr + 8), *(GLeglImageOES *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glEGLImageTargetRenderbufferStorageOES(0x%08x %p )\n",*(GLenum *)(ptr + 8), *(GLeglImageOES *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glAlphaFuncxOES(0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLclampx *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClearColorxOES(0x%08x 0x%08x 0x%08x 0x%08x )\n",*(GLclampx *)(ptr + 8), *(GLclampx *)(ptr + 8 + 4), *(GLclampx *)(ptr + 8 + 4 + 4), *(GLclampx *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClearDepthxOES(0x%08x )\n",*(GLclampx *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClipPlanexOES(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfixed*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClipPlanexIMG(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfixed*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glColor4xOES(0x%08x 0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDepthRangexOES(0x%08x 0x%08x )\n",*(GLclampx *)(ptr + 8), *(GLclampx *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glFogxOES(0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glFogxvOES(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfixed*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glFrustumxOES(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr1 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetClipPlanexOES(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (GLfixed*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpPtr1 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetClipPlanex(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (GLfixed*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpPtr1 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetFixedvOES(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (GLfixed*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetLightxvOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLfixed*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetMaterialxvOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLfixed*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetTexEnvxvOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLfixed*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetTexParameterxvOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLfixed*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLightModelxOES(0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLightModelxvOES(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfixed*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLightxOES(0x%08x 0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLightxvOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLfixed*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLineWidthxOES(0x%08x )\n",*(GLfixed *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLoadMatrixxOES(%p(%u) )\n",(const GLfixed*)(ptr + 8 + 4), *(unsigned int *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMaterialxOES(0x%08x 0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMaterialxvOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLfixed*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMultMatrixxOES(%p(%u) )\n",(const GLfixed*)(ptr + 8 + 4), *(unsigned int *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMultiTexCoord4xOES(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glNormal3xOES(0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glOrthoxOES(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPointParameterxOES(0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPointParameterxvOES(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfixed*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPointSizexOES(0x%08x )\n",*(GLfixed *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glPolygonOffsetxOES(0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glRotatexOES(0x%08x 0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4), *(GLfixed *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glSampleCoveragexOES(0x%08x %d )\n",*(GLclampx *)(ptr + 8), *(GLboolean *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glScalexOES(0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexEnvxOES(0x%08x 0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexEnvxvOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLfixed*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexParameterxOES(0x%08x 0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexParameterxvOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLfixed*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTranslatexOES(0x%08x 0x%08x 0x%08x )\n",*(GLfixed *)(ptr + 8), *(GLfixed *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glIsRenderbufferOES(%u )\n",*(GLuint *)(ptr + 8));
#endif
			*(GLboolean *)(&tmpBuf[0]) = 			this->glIsRenderbufferOES(*(GLuint *)(ptr + 8));
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glBindRenderbufferOES(0x%08x %u )\n",*(GLenum *)(ptr + 8), *(GLuint *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDeleteRenderbuffersOES(%d %p(%u) )\n",*(GLsizei *)(ptr + 8), (const GLuint*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpPtr1 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGenRenderbuffersOES(%d %p(%u) )\n",*(GLsizei *)(ptr + 8), (GLuint*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetRenderbufferParameterivOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLint*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glIsFramebufferOES(%u )\n",*(GLuint *)(ptr + 8));
#endif
			*(GLboolean *)(&tmpBuf[0]) = 			this->glIsFramebufferOES(*(GLuint *)(ptr + 8));
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glBindFramebufferOES(0x%08x %u )\n",*(GLenum *)(ptr + 8), *(GLuint *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDeleteFramebuffersOES(%d %p(%u) )\n",*(GLsizei *)(ptr + 8), (const GLuint*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpPtr1 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGenFramebuffersOES(%d %p(%u) )\n",*(GLsizei *)(ptr + 8), (GLuint*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glCheckFramebufferStatusOES(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			*(GLenum *)(&tmpBuf[0]) = 			this->glCheckFramebufferStatusOES(*(GLenum *)(ptr + 8));
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glFramebufferRenderbufferOES(0x%08x 0x%08x 0x%08x %u )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLenum *)(ptr + 8 + 4 + 4), *(GLuint *)(ptr + 8 + 4 + 4 + 4));
#endif
...
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetFramebufferAttachmentParameterivOES(0x%08x 0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLenum *)(ptr + 8 + 4 + 4), (GLint*)(tmpPtr3), *(unsigned int *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGenerateMipmapOES(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMapBufferOES(0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glUnmapBufferOES(0x%08x )\n",*(GLenum *)(ptr + 8));
#endif
			*(GLboolean *)(&tmpBuf[0]) = 			this->glUnmapBufferOES(*(GLenum *)(ptr + 8));
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetBufferPointervOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLvoid**)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glCurrentPaletteMatrixOES(%u )\n",*(GLuint *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glLoadPaletteFromModelViewMatrixOES()\n");
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMatrixIndexPointerOES(%d 0x%08x %d %p(%u) )\n",*(GLint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLsizei *)(ptr + 8 + 4 + 4), (const GLvoid*)(ptr + 8 + 4 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glWeightPointerOES(%d 0x%08x %d %p(%u) )\n",*(GLint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLsizei *)(ptr + 8 + 4 + 4), (const GLvoid*)(ptr + 8 + 4 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4 + 4));
#endif
...
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glQueryMatrixxOES(%p(%u) %p(%u) )\n",(GLfixed*)(tmpPtr0), *(unsigned int *)(ptr + 8), (GLint*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4));
#endif
			*(GLbitfield *)(&tmpBuf[0 + tmpPtr0Size + tmpPtr1Size]) = 			this->glQueryMatrixxOES((GLfixed*)(tmpPtr0), (GLint*)(tmpPtr1));
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDepthRangefOES(%f %f )\n",*(GLclampf *)(ptr + 8), *(GLclampf *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glFrustumfOES(%f %f %f %f %f %f )\n",*(GLfloat *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glOrthofOES(%f %f %f %f %f %f )\n",*(GLfloat *)(ptr + 8), *(GLfloat *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4 + 4), *(GLfloat *)(ptr + 8 + 4 + 4 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClipPlanefOES(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfloat*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClipPlanefIMG(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (const GLfloat*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpPtr1 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetClipPlanefOES(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (GLfloat*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glClearDepthfOES(%f )\n",*(GLclampf *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexGenfOES(0x%08x 0x%08x %f )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLfloat *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexGenfvOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLfloat*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexGeniOES(0x%08x 0x%08x %d )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLint *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexGenivOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLint*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexGenxOES(0x%08x 0x%08x 0x%08x )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLfixed *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTexGenxvOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (const GLfixed*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetTexGenfvOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLfloat*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetTexGenivOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLint*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetTexGenxvOES(0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), (GLfixed*)(ptr + 8 + 4 + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glBindVertexArrayOES(%u )\n",*(GLuint *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDeleteVertexArraysOES(%d %p(%u) )\n",*(GLsizei *)(ptr + 8), (const GLuint*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpPtr1 = &tmpBuf[0];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGenVertexArraysOES(%d %p(%u) )\n",*(GLsizei *)(ptr + 8), (GLuint*)(tmpPtr1), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glIsVertexArrayOES(%u )\n",*(GLuint *)(ptr + 8));
#endif
			*(GLboolean *)(&tmpBuf[0]) = 			this->glIsVertexArrayOES(*(GLuint *)(ptr + 8));
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMultiDrawArraysSUN(0x%08x %p(%u) %p(%u) %d )\n",*(GLenum *)(ptr + 8), (GLint*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4), (GLsizei*)(ptr + 8 + 4 + 4 + *(tsize_t *)(ptr +8 + 4) + 4), *(unsigned int *)(ptr + 8 + 4 + 4 + *(tsize_t *)(ptr +8 + 4)), *(GLsizei *)(ptr + 8 + 4 + 4 + *(tsize_t *)(ptr +8 + 4) + 4 + *(tsize_t *)(ptr +8 + 4 + 4 + *(tsize_t *)(ptr +8 + 4))));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glMultiDrawElementsSUN(0x%08x %p(%u) 0x%08x %p(%u) %d )\n",*(GLenum *)(ptr + 8), (const GLsizei*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4), *(GLenum *)(ptr + 8 + 4 + 4 + *(tsize_t *)(ptr +8 + 4)), (const GLvoid**)(ptr + 8 + 4 + 4 + *(tsize_t *)(ptr +8 + 4) + 4 + 4), *(unsigned int *)(ptr + 8 + 4 + 4 + *(tsize_t *)(ptr +8 + 4) + 4), *(GLsizei *)(ptr + 8 + 4 + 4 + *(tsize_t *)(ptr +8 + 4) + 4 + 4 + *(tsize_t *)(ptr +8 + 4 + 4 + *(tsize_t *)(ptr +8 + 4) + 4)));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDeleteFencesNV(%d %p(%u) )\n",*(GLsizei *)(ptr + 8), (const GLuint*)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glIsFenceNV(%u )\n",*(GLuint *)(ptr + 8));
#endif
			*(GLboolean *)(&tmpBuf[0]) = 			this->glIsFenceNV(*(GLuint *)(ptr + 8));
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glTestFenceNV(%u )\n",*(GLuint *)(ptr + 8));
#endif
			*(GLboolean *)(&tmpBuf[0]) = 			this->glTestFenceNV(*(GLuint *)(ptr + 8));
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glFinishFenceNV(%u )\n",*(GLuint *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glSetFenceNV(%u 0x%08x )\n",*(GLuint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4));
#endif
...
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glGetDriverControlsQCOM(%p(%u) %d %p(%u) )\n",(GLint*)(tmpPtr0), *(unsigned int *)(ptr + 8), *(GLsizei *)(ptr + 8 + 4), (GLuint*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glEnableDriverControlQCOM(%u )\n",*(GLuint *)(ptr + 8));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glDisableDriverControlQCOM(%u )\n",*(GLuint *)(ptr + 8));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0 + tmpPtr0Size];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glExtGetTexturesQCOM(%p(%u) %d %p(%u) )\n",(GLuint*)(tmpPtr0), *(unsigned int *)(ptr + 8), *(GLint *)(ptr + 8 + 4), (GLint*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0 + tmpPtr0Size];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glExtGetBuffersQCOM(%p(%u) %d %p(%u) )\n",(GLuint*)(tmpPtr0), *(unsigned int *)(ptr + 8), *(GLint *)(ptr + 8 + 4), (GLint*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0 + tmpPtr0Size];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glExtGetRenderbuffersQCOM(%p(%u) %d %p(%u) )\n",(GLuint*)(tmpPtr0), *(unsigned int *)(ptr + 8), *(GLint *)(ptr + 8 + 4), (GLint*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0 + tmpPtr0Size];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glExtGetFramebuffersQCOM(%p(%u) %d %p(%u) )\n",(GLuint*)(tmpPtr0), *(unsigned int *)(ptr + 8), *(GLint *)(ptr + 8 + 4), (GLint*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
...
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glExtGetTexLevelParameterivQCOM(%u 0x%08x %d 0x%08x %p(%u) )\n",*(GLuint *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLint *)(ptr + 8 + 4 + 4), *(GLenum *)(ptr + 8 + 4 + 4 + 4), (GLint*)(tmpPtr4), *(unsigned int *)(ptr + 8 + 4 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glExtTexObjectStateOverrideiQCOM(0x%08x 0x%08x %d )\n",*(GLenum *)(ptr + 8), *(GLenum *)(ptr + 8 + 4), *(GLint *)(ptr + 8 + 4 + 4));
#endif
...
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glExtGetTexSubImageQCOM(0x%08x %d %d %d %d %d %d %d 0x%08x 0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), *(GLint *)(ptr + 8 + 4), *(GLint *)(ptr + 8 + 4 + 4), *(GLint *)(ptr + 8 + 4 + 4 + 4), *(GLint *)(ptr + 8 + 4 + 4 + 4 + 4), *(GLsizei *)(ptr + 8 + 4 + 4 + 4 + 4 + 4), *(GLsizei *)(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4), *(GLsizei *)(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4), *(GLenum *)(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4), *(GLenum *)(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4), (GLvoid*)(tmpPtr10), *(unsigned int *)(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4));
#endif
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glExtGetBufferPointervQCOM(0x%08x %p(%u) )\n",*(GLenum *)(ptr + 8), (GLvoid**)(ptr + 8 + 4 + 4), *(unsigned int *)(ptr + 8 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0 + tmpPtr0Size];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glExtGetShadersQCOM(%p(%u) %d %p(%u) )\n",(GLuint*)(tmpPtr0), *(unsigned int *)(ptr + 8), *(GLint *)(ptr + 8 + 4), (GLint*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpPtr2 = &tmpBuf[0 + tmpPtr0Size];
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glExtGetProgramsQCOM(%p(%u) %d %p(%u) )\n",(GLuint*)(tmpPtr0), *(unsigned int *)(ptr + 8), *(GLint *)(ptr + 8 + 4), (GLint*)(tmpPtr2), *(unsigned int *)(ptr + 8 + 4 + 4));
#endif
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glExtIsProgramBinaryQCOM(%u )\n",*(GLuint *)(ptr + 8));
#endif
			*(GLboolean *)(&tmpBuf[0]) = 			this->glExtIsProgramBinaryQCOM(*(GLuint *)(ptr + 8));
			...
			{
#ifdef DEBUG_PRINTOUT
			fprintf(stderr,"gl: glEndTilingQCOM(0x%08x )\n",*(GLbitfield *)(ptr + 8));
#endif
